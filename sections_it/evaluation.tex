...
\subsection{Resource Quality and Coverage}
...
We evaluated relation extraction on a sample of 300 relations drawn from 8 randomly selected DeSmog profile pages, with three annotators (the authors) working in pairs and disagreements resolved by discussion, assessing each relation for truthfulness, validity, and temporal correctness\footnote{Full annotation guidelines: \url{https://bit.ly/lack_42bhqzl}.}.
