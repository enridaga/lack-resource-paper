...
\begin{abstract}
Organised lobbying against climate science is extensively documented by investigative platforms such as DeSmog and LobbyMap, yet the information they produce remains fragmented, heterogeneous, and difficult to analyse at scale. We present LACK (Lobbying Against Climate Knowledge), a knowledge graph of ~28k entities and ~200k typed relations — covering affiliations, funding ties, leadership roles, and organisational partnerships — constructed from over 2k web profiles via an LLM-based relation extraction and entity linking pipeline. 
LACK is described using a purpose-built OWL ontology, includes provenance and temporal annotations, is linked to Wikidata and DBpedia, and published as Linked Open Data under CC BY 4.0 following FAIR principles. 
