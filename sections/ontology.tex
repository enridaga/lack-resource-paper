...
\begin{sloppypar}LACK captures this through two mechanisms.
Entity-level temporal bounds are recorded directly on \texttt{lack:Person} and \texttt{lack:Collective} instances using the datatype properties \texttt{lack:activeSince} and \texttt{lack:activeUntil} (range: \texttt{xsd:gYear}).\end{sloppypar}
