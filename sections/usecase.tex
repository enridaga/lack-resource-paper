...
The first use case identifies entities that may not have been related without integrating the data sources\footnote{We present more of these examples on our website: \url{https://climatesense-project.eu/lack/case-studies.html}.}
The second use case connects the most connected LACK Collectives with the attendance list of COP30 (the United Nations Climate Change Conference), and identifies potential investigations.

\paragraph{LACK enables integration of multiple independent sources.} 
...
\begin{sloppypar}\paragraph{Example 1: Darren Woods $\rightarrow$ Exxon $\rightarrow$ Heartland Institute}
...
\end{sloppypar}
\begin{sloppypar}
\paragraph{Example 2: Cambridge Analytica $\rightarrow$ BP $\rightarrow$ Business Council of Australia}
...
A qualitative look at the top-20 scope shows the LACK's most densely documented entities: the US climate countermovement (Heartland, Cato, ALEC, Heritage, Manhattan Institute) --- of which only three (US Chamber of Commerce, Shell, ExxonMobil) appear at COP30 at all.
